...
class Fuul {
     ...
     * ```
     */
    sendEvent(name, { args, userAddress, projectId, signature, signatureMessage } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!tracking_id)
                return;
            const reqBody = Object.assign(Object.assign(Object.assign(Object.assign({ name,
                session_id, event_args: args }, (userAddress && { user_address: userAddress })), { metadata: Object.assign(Object.assign(Object.assign({}, (referrerId && { referrer: referrerId })), (projectId && { project_id: projectId })), { tracking_id,
                    source,
                    category,
                    title,
                    tag }) }), (signature && { signature })), (signatureMessage && { signature_message: signatureMessage }));
